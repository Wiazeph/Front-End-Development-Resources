globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unified/index.js';
import { toString } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/remark-rehype/index.js';
import { all } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/detab/index.js';
import { u } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unist-builder/index.js';
import { encode } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/mdurl/index.js';
import slugify from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/slugify/slugify.js';
import { position } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unist-util-position/index.js';
import { visit } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/unenv/runtime/npm/consola.mjs';
...
const appConfig0 = defineAppConfig({
  docus: {
    ...
    socials: {
      github: "emr3rden/Front-End-Development-Resources"
    },
    aside: {
      level: 0,
      exclude: []
    ...
    header: {
      title: "Frontend Resources Development"
    },
    github: {
      edit: true,
      repo: "Front-End-Development-Resources",
      branch: "main",
      owner: "emr3rden"
    }
  }
...
const serverAssets = [{"baseName":"server","dir":"/Users/aliosmandelismen/Documents/frontendweb/server/assets"}];
...
storage.mount('pinceau', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/aliosmandelismen/Documents/frontendweb/.nuxt/pinceau/theme","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/aliosmandelismen/Documents/frontendweb/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/aliosmandelismen/Documents/frontendweb/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aliosmandelismen/Documents/frontendweb","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aliosmandelismen/Documents/frontendweb/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aliosmandelismen/Documents/frontendweb/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aliosmandelismen/Documents/frontendweb/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lvEwPEElyF = (function(nitro) {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/aliosmandelismen/Documents/frontendweb/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _m8iNfC = defineEventHandler(async (event) => {
...
const _hYasm5 = defineEventHandler(async (event) => {
...
const _judC4z = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_50DPPi = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_50DPPi, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _m8iNfC, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _m8iNfC, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _m8iNfC, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _hYasm5, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _judC4z, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _judC4z, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _judC4z, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_50DPPi, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/aliosmandelismen/Documents/frontendweb/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/aliosmandelismen/Documents/frontendweb/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
